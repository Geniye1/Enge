...
namespace Enge {
	...
	void ImGuiEditorManager::ShowDockSpace(bool* open) {
		...
		static ImGuiDockNodeFlags dockspace_flags = ImGuiDockNodeFlags_None; // No docking flags so that the parent window is not dockable to
		...
		if (io.ConfigFlags & ImGuiConfigFlags_DockingEnable) {
			...
			LOG(ENGE_INFO, "ImGui: Docking has been disabled\n");
		}
	...
	void ImGuiEditorManager::SetStyle() {

		// Style by Derydoca at https://github.com/ocornut/imgui/issues/707
